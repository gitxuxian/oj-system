...
public class LoggingAspect {
     ...
     */
    @Around("execution(* com.yupi.xuoj.judge.codesandbox.CodeSandBox.excuteCode(com.yupi.xuoj.judge.codesandbox.model.ExecuteCodeRequest))")
